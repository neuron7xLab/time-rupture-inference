...
| v9 | 🔴 RED | learned echo-state vs validated v8.4 bench: PARTIALLY recovers (beats scalar oracle +26%, vs_scalar 0.258) but does NOT reach causal floor (h2r 6.47 ≫ 0.35; learned 5.92 vs oracle-floor 0.19). Discoverable ≠ recovered by a generic small learner — preserved |
