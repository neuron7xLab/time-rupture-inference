...
| Redacted hypothesis interface | Original integration | `docs/PRIVATE_RND_PROTOCOL.md`, `examples/indi_redacted_temporal_hypothesis.yaml`, opaque-probe API | Tests shape, never mechanism/data/theorem | A real hypothesis class that cannot be expressed without leaking a never-share field |
