...
## 1. Parent v8.1 RED
Preserved (evidence/V8_1_PARENT_RED.md): real but carrier-masked scalar-inexpressibility, gap 0.1525.

## 2. Why whole-stream MAE masked the signal
The deterministic carrier inflated both stationary-oracle MAEs, diluting the trigger-specific gap below 0.25.

## 3. Trigger-scoped metric
MAE restricted to the aliased z-dependent trigger windows.

## 4. Carrier-controlled metric
Observation-derived phase mean (no z / future / schedule) removed from both oracles; residual z-channel compared.

## 5. Oracle hierarchy
scalar < history < regime by access; regime = floor.
...
## 9. Claim boundary
Validated task-evaluation property only; no capability/cognition/AGI claim.

## 10. Next PR
Not GREEN -> preserve; diagnose before any further lineage. No model.
